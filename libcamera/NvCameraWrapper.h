...
class NvCameraWrapper : public CameraHardwareInterface {
public:
...
private:
    ...
    NvCameraWrapper(sp<CameraHardwareInterface>& nvInterface);
    virtual ~NvCameraWrapper();
    ...
    sp<CameraHardwareInterface> mNvInterface;
    bool mVideoMode;
